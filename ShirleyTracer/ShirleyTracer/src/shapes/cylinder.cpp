...
bool OpenCylinder::hitP(const ray& r, float& t) const {
...
bool OpenCylinder::hit(const ray& r, float t_min, float t_max, hit_record& rec) const {
...
bool SolidCylinder::hit(const ray& r, float t_min, float t_max, hit_record& rec) const {
	return Compound::hit(r, t_min, t_max, rec);
}

bool SolidCylinder::hitP(const ray& r, float& t) const {
	return Compound::hitP(r, t);
}